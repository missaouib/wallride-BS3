...
public interface PublisherRepository extends JpaRepository<Publisher, Long>, PublisherRepositoryCustom {
	...
	Publisher findOneForUpdateById(Long id);

	@EntityGraph(value = Publisher.DEEP_GRAPH_NAME, type = EntityGraph.EntityGraphType.FETCH)
	Publisher findOneByCodeAndLanguage(String code, String language);
}
