...
public class CustomFieldEditController {
	...
	public CustomField setupCustomField(@PathVariable String language, @RequestParam long id) {
	...
	public String update(
		...
		if (errors.hasErrors()) {
			...
			//  	logger.info("error[{}] = {},", i++, er);
			//  }	
			//logger.info("Errors: {}", errors);
			if (errors.getFieldError("type") != null)	errors.rejectValue("type", "NotFound");
			return "customfield/edit";
		}
