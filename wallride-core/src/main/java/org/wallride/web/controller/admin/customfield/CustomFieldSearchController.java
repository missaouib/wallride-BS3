...
public class CustomFieldSearchController {
	private static Logger logger = LoggerFactory.getLogger(CustomFieldSearchController.class);
    ...
    public String partBulkDeleteForm(@PathVariable String language) {
        logger.info("enter CustomFieldSearchController.partBulkDeleteForm(...):");
